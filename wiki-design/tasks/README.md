...
| [task_20260528_007](TASK-007-apply-rfc-007.md) | Apply RFC-007 — 实现 wiki-graph MVP（wiki_common + wiki_graph.py + 文档同步） | pending (spec v2 approved, ready to execute) | claude | codex | RFC-007 |

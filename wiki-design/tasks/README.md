...
| [task_20260528_008](TASK-008-apply-rfc-008.md) | Apply RFC-008 — 实现 schema profile 机制（BASE_SCHEMA + overlay + --root） | pending (待 codex spec review) | claude | codex | RFC-008 |

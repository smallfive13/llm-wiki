...
| [task_20260528_009](TASK-009-apply-rfc-009.md) | Apply RFC-009 — wikilink 约定（wiki_graph lookup + 迁移 4 页 + 文档同步） | pending (spec v3 approved, ready to execute) | claude | codex | RFC-009 |

...
| [task_20260526_003](TASK-003-apply-rfc-003.md) | Apply RFC-003 — capture 机制 + inbox 缓冲层落到 AGENTS / 01 / 02 / 04 / 05 / .gitignore | pending (spec v2 approved, ready to execute) | claude | codex | RFC-003 |

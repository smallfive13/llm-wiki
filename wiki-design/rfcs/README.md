...
| [rfc_20260622_027](RFC-027-code-knowledgization.md) | DataWorks 代码知识化（M1+M2 accepted：asset-mapping 页型 + 代码梳理/传导口径；M3+M4 deferred：失效检测/回源待接口核实） | accepted | claude | `wiki-design/02-workflows.md`, `scripts/wiki_freshness.py`, `scripts/wiki_common.py`, `scripts/README.md`, `tests/` |

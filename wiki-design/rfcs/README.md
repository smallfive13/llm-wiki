...
| [rfc_20260601_011](RFC-011-wiki-init-obsidian-friendly.md) | wiki_init Obsidian 友好初始化（排除派生层 + 结构化上下文层占位） | proposed | claude | `scripts/wiki_init.py`, `scripts/README.md` |

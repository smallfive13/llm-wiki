...
| [rfc_20260604_017](RFC-017-source-manifest-status.md) | source_manifest.status 加 superseded / archived（对齐 source 生命周期） | proposed | claude | `scripts/wiki_common.py`, `scripts/wiki_lint.py`, `scripts/README.md`, `knowledge/.wiki-schema.md` |
